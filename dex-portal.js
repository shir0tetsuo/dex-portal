...
class ResponseBlock{
  constructor(pagename,bodyloader,top_extended){
    ...
    fhead = await readFile('./part/header.html')
    fpubver = await readFile('./part/pub_ver.html')
    ftophead = await readFile('./part/top_head.html')
...
X.get('/bank', async(req, res) => {
  ...
  RB = await new ResponseBlock('bank','<body>','<a href="/ucp">UCP//</a>')
